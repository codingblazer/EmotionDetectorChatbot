...
import com.affectiva.affdexme.GamePart.GameInitActivity;
import com.affectiva.affdexme.Networking.ApiClientChatbot;
...
//                progressBarLayout.setVisibility(View.GONE);
        ...
        call.enqueue(new Callback<Question>() {
            ...
            public void onResponse(Call<Question> call, Response<Question> response) {
                if(response.isSuccessful())
                    ...
                    Toast.makeText(MainActivity.this,"Sorry Unexpected problem occured",Toast.LENGTH_LONG).show();
                mView.dismiss();
            }
    ...
    private void loadDummyHistory(){
        ...
        msg.setMe(true);
        msg.setMessage("Hi");
        msg.setDate(java.text.DateFormat.getDateTimeInstance().format(new Date()));
        chatHistory.add(msg);
        ChatMessage msg1 = new ChatMessage();
        msg1.setId(2);
        msg1.setMe(true);
        msg1.setMessage("This is your Chatbot.Ask me any question!!");
        msg1.setDate(java.text.DateFormat.getDateTimeInstance().format(new Date()));
